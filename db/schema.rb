...
ActiveRecord::Schema.define(version: 2021_06_11_222846) do
  ...
  add_foreign_key "interview_schedules", "interviewees"
  add_foreign_key "interview_schedules", "interviewers"
end
